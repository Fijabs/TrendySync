      ...
      <nav className="gradient-bg text-white shadow-lg">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <Link
              href="/login"
              className="px-4 py-2 rounded-full bg-white text-purple-700 font-semibold hover:bg-gray-100"
            >
              Login
            </Link>
            <Link
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link
                  href="/dashboard"
                  className="px-6 py-3 border border-white text-white font-bold rounded-lg hover:bg-white hover:text-purple-700 transition duration-300 flex items-center justify-center"
                >
                  View Dashboard Demo
                </Link>
              </div>
            ...
            <div className="md:w-1/2">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 shadow-lg">
                ...
                <div className="text-center mt-3">
                  <Link href="/dashboard" className="text-white hover:underline inline-flex items-center">
                    Click to explore the dashboard <i className="fas fa-arrow-right ml-2"></i>
                  </Link>
                </div>
              </div>
            </div>
      ...
      <section id="features" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-12">
            <Link
              href="/dashboard"
              className="inline-flex items-center px-6 py-3 bg-purple-600 text-white font-bold rounded-lg hover:bg-purple-700 transition duration-300"
            >
              Explore Dashboard Demo <i className="fas fa-arrow-right ml-2"></i>
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Experience Our Powerful Dashboard</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Get a feel for how TrendSync works with our interactive dashboard demo.
            </p>
          </div>

          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="p-4 border-b">
              <h3 className="font-bold">TrendSync Dashboard Preview</h3>
            </div>
            <div className="p-6">
              <Link href="/dashboard">
                <img
                  src="/placeholder.svg?height=400&width=800"
                  alt="TrendSync Dashboard"
            ...
            <div className="p-4 bg-gray-50 text-center">
              <Link
                ...
                className="inline-flex items-center px-6 py-3 bg-purple-600 text-white font-bold rounded-lg hover:bg-purple-700 transition duration-300"
              >
                Explore Full Dashboard <i className="fas fa-external-link-alt ml-2"></i>
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
              ...
              <Link
                href="/dashboard"
                className="px-8 py-3 border border-white text-white font-bold rounded-lg hover:bg-white hover:text-purple-700 transition duration-300 flex items-center justify-center"
              >
                Explore Dashboard
              </Link>
            </div>
